                ...
                <div class="col-xs-12">
                    <div class="banner-content-wrapper">
                        <div class="banner-content">
                            <h2>Inscrições Universitárias</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="courses-details">
                    <div class="course-details-content">
                        ...
                        <div class="single-course-left">
                            ...
                            <p>Número de Paoctes aplicáveis em cada Universidade
                            </p>
                                ...
                                <table class="table">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th scope="col">3 Pacotes</th>
                                            <th scope="col">6 Pacotes</th>
                                            <th scope="col">10 Pacotes</th>
                                            <th scope="col">12 Pacotes</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                    ...
                    <div class="reply-area">
                        <form id="contact-form" action="http://preview.hasthemes.com/eduhome/mail.php" method="post">
                            <a class="reply-btn" href="{{url("pessoal")}}" data-text="send"><span>Aplicar</span></a>
