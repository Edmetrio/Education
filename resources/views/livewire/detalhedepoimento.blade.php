                ...
                <div class="col-md-8">
                    <div class="event-details">
                        <div class="event-details-img">
                            <img src="{{asset('storage')}}/{{$depoimento->icon}}" alt="event-details">
                        ...
                        <div class="event-details-content">
                            ...
                            <p>Visite o depoimento: <a href="{{$depoimento->link}}">{{$depoimento->link}}</a></p>
                            <p></p>
                            <div class="speakers-area fix">
                                <h4>Outros Depoimentos</h4>
                                @foreach($depoimentos as $p)
                                <div class="single-speaker">
                                    <div class="speaker-img">
                                        <img src="{{asset('storage')}}/{{$p->icon}}" width="120px" height="120px" alt="{{$p->nome}}">
                                    </div>
                                    <div class="speaker-name">
                                        <h5><a href="{{ url('depoimento', $p->id) }}"> {{ $p->nome }} </a></h5>
                                        <!-- <p>{{ $p->localizacao }}</p> -->
                                    </div>
                                </div>
                                @endforeach
