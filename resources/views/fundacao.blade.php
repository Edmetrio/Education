                    ...
                    <div class="col-md-8">
                        <div class="courses-details">
                            <div class="course-details-content">
                                ...
                                <p>Este serviço é fornecido a todo cliente que não possui os requisitos necessários para iniciar de imediato um curso superior devido a não equivalência de certificado (sistema de ensino diferente do local de destino) ou não conclusão da 12ª classe (tendo terminado a 11ª classe).
                                </p>
                            ...
                            <div class="reply-area">
                                <form id="contact-form" action="http://preview.hasthemes.com/eduhome/mail.php" method="post">
                                    <a class="reply-btn" href="https://forms.gle/7YWuDzZByBa8aV8M7" data-text="send"><span>Aplicar</span></a>
