                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="localizacao" class="form-control" placeholder="Nicósia, Chipre">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>Localização:</strong>
                                            <input type="text" wire:model="edit_localizacao" class="form-control" placeholder="Nicósia, Chipre">
                                            @error('edit_localizacao') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
