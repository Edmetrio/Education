                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="teacher-details-content ml-50">
                            <h2>Samo Amós Fumo</h2>
                            <h5>Tradutor de Inglês-Português</h5>
                            <h4>Perfil</h4>
                            <p>Serviços: tradução de todo o tipo de documentos, interpretação, revisão linguística de textos, transcrição de áudios, dublagem e legendagem de vídeos </p>
                            <ul>
                                <li><span>Grau: </span>Licenciado</li>
                                <li><span>Experiência: </span>10 Aanos</li>
                                <!-- <li><span>hobbies: </span>music, travelling, catching fish</li>
                                <li><span>Faculdade: </span>Din, Department of Micro Biology</li> -->
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="teacher-contact">
                            <h4>Contactos</h4>
                            <p><span>E-mail : </span>samotraducoes@gmail.com <br> samoamos@outlook.com</p>
                            <p><span>Contactos : </span>(+258) 842214301</p>
                            <p><span>Linkedln : </span> Samo Amós Fumo</p>
                            <ul>
                                <li><a href="https://https://l.wl.co/l?u=https%3A%2F%2Ffacebook.com%2Fsamotradutorajuramentado"><i class="zmdi zmdi-facebook"></i></a></li>
                                <li><a href="https://www.wa.me/+258875078033"><i class="zmdi zmdi-whatsapp"></i></a></li>
